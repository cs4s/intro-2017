---
layout: default
title: CS4S Introduction Workshop @ UON 2017 - Glossary
---
...
- **Scratch Concepts/Terms:** these are the concepts and terms that are specific to Scratch (although they may also be used in other, similar languages like [Snap!](http://snap.berkeley.edu/){:target="_blank"}).
...
Let us know if you think there are terms commonly used that should be added to the glossary for future workshops or if any of the definitions below could be improved.
